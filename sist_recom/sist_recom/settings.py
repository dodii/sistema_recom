"""
Django settings for sist_recom project.
...
UCAMPUS_USER = env("UCAMPUS_USER")
UCAMPUS_PASSWORD = env("UCAMPUS_PASSWORD")
...
WSGI_APPLICATION = "sist_recom.wsgi.application"
